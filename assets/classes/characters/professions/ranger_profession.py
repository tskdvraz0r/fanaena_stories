...
class RangerProfession(BasicProfession):
    """
    Notes:
    ...
    Attributes:
        ...
        * self._stamina_points_dice (int): кубик, отвечающий за очки стамины. По умолчанию 8;
    ...
    def __init__(self) -> None:
        ...
        self._stamina_points_dice: int = 8
